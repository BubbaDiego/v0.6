...
def save_theme_route():
    try:
        ...
        # Only update profile data if non-empty; otherwise, leave existing settings intact
        if "data" in new_theme_data and new_theme_data["data"]:
            conf["theme_config"]["profiles"][profile_name] = new_theme_data["data"]
        # Always update the selected_profile
...
# ---------------------------------------------------------------------------
# Context Processor - Updated to use new theme_config
# ---------------------------------------------------------------------------
